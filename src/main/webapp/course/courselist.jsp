...
<table class="layui-table">
	<thead><tr><th>课程编号</th><th>课程名称</th><th>学分</th><th>学时</th><th>课程类型</th><th>选课人数</th></tr></thead>
	<tbody>
		  ...
		  laypage.render({
		    ...
		    ,jump: function(obj, first){
		        ...
		        if(!first){
		        	...
		        	var url = "<%=request.getContextPath()%>/course/courselist?pageNum=" +obj.curr+"&pageSize="+obj.limit;
		        	console.log(url);
