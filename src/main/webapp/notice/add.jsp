		...
		<div class="layui-row">
			<form id="form1" class="layui-form" action="<%=request.getContextPath()%>/notice/save" method="post">
				...
				<div class="layui-form-item layui-form-text">
    				...
    				<div class="layui-input-block">
      					<textarea wrap="hard" rows="20" cols="200" required="required" id="context" placeholder="请输入内容" class="layui-textarea" name="context">${obj.context}</textarea>
    				</div>
  				</div>
  				<div class="layui-form-item">
    				<button class="layui-btn" type="submit" onclick="formatTo()">保存</button>
